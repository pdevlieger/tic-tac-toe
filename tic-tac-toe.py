...
# I just use these functions so it's a bit more robust in case the playing field will be
# defined differently. Maybe allow players to make their own playing field that should
...
def get_player_name(player):
	...
	while player_name == "":
			player_name = raw_input("I need a name for pete's sake! What is the name of "
									+player+"? ")
	return player_name
...
# Comments:
# - I did not use the exit command.
# - The way the patterns are checked are a bit lengthy, but quite robust. Should I do it differently?
